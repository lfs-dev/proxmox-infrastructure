...
resource "proxmox_virtual_environment_vm" "ubuntu_vm" {
  name        = "${var.vm_name}.prod" #Nome da VM
  # name        = "<nome-da-vm>" 
  description = "Ambiente de Produção do Projeto ${var.vm_name}" #Descrição
  # description        = "Ambiente de Produção do Projeto <nome-do-projeto>" 
